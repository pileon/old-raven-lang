...
The language is largely asynchronous and event based. Unlike Node.js Raven
Script doesn't use callbacks to the same extent, but instead uses futures
and promise objects.

Asynchronous functions returns an object that allows programers to create
"when done do this" chains.
